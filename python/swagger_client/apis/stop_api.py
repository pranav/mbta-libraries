...
class StopApi(object):
    ...
    def api_stop_controller_index(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_stop_controller_index(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.api_stop_controller_index_with_http_info(**kwargs)
        else:
            (data) = self.api_stop_controller_index_with_http_info(**kwargs)
            return data

    def api_stop_controller_index_with_http_info(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_stop_controller_index_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_stop_controller_index" % key
                )
            params[key] = val
        del params['kwargs']

        if 'page_offset' in params and params['page_offset'] < 0:
            raise ValueError("Invalid value for parameter `page_offset` when calling `api_stop_controller_index`, must be a value greater than or equal to `0`")
        if 'page_limit' in params and params['page_limit'] < 1:
            raise ValueError("Invalid value for parameter `page_limit` when calling `api_stop_controller_index`, must be a value greater than or equal to `1`")
    ...
    def api_stop_controller_show(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_stop_controller_show(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.api_stop_controller_show_with_http_info(id, **kwargs)
        else:
            (data) = self.api_stop_controller_show_with_http_info(id, **kwargs)
            return data

    def api_stop_controller_show_with_http_info(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.api_stop_controller_show_with_http_info(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_stop_controller_show" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_stop_controller_show`")
