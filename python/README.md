...
------------ | ------------- | ------------- | -------------
*AlertApi* | [**api_alert_controller_index**](docs/AlertApi.md#api_alert_controller_index) | **GET** /alerts | 
*AlertApi* | [**api_alert_controller_show**](docs/AlertApi.md#api_alert_controller_show) | **GET** /alerts/{id} | 
*FacilityApi* | [**api_facility_controller_index**](docs/FacilityApi.md#api_facility_controller_index) | **GET** /facilities | 
*FacilityApi* | [**api_facility_controller_show**](docs/FacilityApi.md#api_facility_controller_show) | **GET** /facilities/{id} | 
*PredictionApi* | [**api_prediction_controller_index**](docs/PredictionApi.md#api_prediction_controller_index) | **GET** /predictions | 
*RouteApi* | [**api_route_controller_index**](docs/RouteApi.md#api_route_controller_index) | **GET** /routes | 
*RouteApi* | [**api_route_controller_show**](docs/RouteApi.md#api_route_controller_show) | **GET** /routes/{id} | 
*ScheduleApi* | [**api_schedule_controller_index**](docs/ScheduleApi.md#api_schedule_controller_index) | **GET** /schedules | 
*ShapeApi* | [**api_shape_controller_index**](docs/ShapeApi.md#api_shape_controller_index) | **GET** /shapes | 
*ShapeApi* | [**api_shape_controller_show**](docs/ShapeApi.md#api_shape_controller_show) | **GET** /shapes/{id} | 
*StopApi* | [**api_stop_controller_index**](docs/StopApi.md#api_stop_controller_index) | **GET** /stops | 
*StopApi* | [**api_stop_controller_show**](docs/StopApi.md#api_stop_controller_show) | **GET** /stops/{id} | 
*TripApi* | [**api_trip_controller_index**](docs/TripApi.md#api_trip_controller_index) | **GET** /trips | 
*TripApi* | [**api_trip_controller_show**](docs/TripApi.md#api_trip_controller_show) | **GET** /trips/{id} | 
*VehicleApi* | [**api_vehicle_controller_index**](docs/VehicleApi.md#api_vehicle_controller_index) | **GET** /vehicles | 
*VehicleApi* | [**api_vehicle_controller_show**](docs/VehicleApi.md#api_vehicle_controller_show) | **GET** /vehicles/{id} | 
